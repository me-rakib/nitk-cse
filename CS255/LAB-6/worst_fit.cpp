...
int main()
{
    ...
    for (i = 0; i < total_process; i++)
    {
        ...
        // if worst index found where internal fragmentation is maximum
        if (worst_index != -1)
        {
            allocated_block[i] = worst_index+1;
            internal_fragmentation[i] = block_size[worst_index] - process_size[i];
